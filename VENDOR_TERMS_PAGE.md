...
title: "Vendor Terms & Onboarding Agreement | MEGAFIXX Home Services LLC",
description:
"Vendor Terms & Onboarding Agreement for vendors applying to the MEGAFIXX Home Services LLC network.",
path: "/vendors/terms",
});
   ...
   <div className="min-h-screen bg-white pt-20">
     <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
       <div className="mb-10">
         ...
         <p className="font-body text-text-muted text-lg">MEGAFIXX HOME SERVICES LLC</p>
       </div>
       ...
       <div className="bg-surface-100 border border-surface-200 rounded-xl p-8 md:p-12 space-y-8 font-body text-text-muted leading-relaxed">
         <p>
           Thank you for your interest in partnering with Megafixx Home Services LLC ("Megafixx").
         </p>
         <p>
           This Vendor Terms & Onboarding Agreement outlines the standards, responsibilities, and expectations required to become and remain an approved vendor within the Megafixx network.
         </p>
         <p>
           By submitting your vendor application through the Megafixx onboarding platform, you acknowledge and agree to the following:
         </p>


         <section>
           <h2 className="font-display text-2xl font-bold text-charcoal mb-3">1. Independent Contractor Status</h2>
           <p>All vendors onboarded through Megafixx operate as independent contractors.</p>
           <p>Vendor acknowledges that they are not employees, representatives, partners, or agents of Megafixx Home Services LLC.</p>
         ...
         <section>
           ...
           <p>Vendor certifies that all onboarding information submitted to Megafixx is accurate, complete, and current, including but not limited to:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
           ...
           <p>Vendor agrees to promptly update Megafixx regarding any changes to submitted information.</p>
           <p>Megafixx reserves the right to suspend or remove vendors that provide false, misleading, incomplete, expired, or fraudulent information.</p>
         </section>
         ...
         <section>
           ...
           <p>Megafixx may request proof of licensing or compliance documentation at any time during the vendor relationship.</p>
         </section>
         ...
         <section>
           ...
           <p>Megafixx may require updated Certificates of Insurance (COI) before assigning work orders or maintaining active vendor status.</p>
         </section>
         ...
         <section>
           ...
           <p>Megafixx reserves the right to evaluate vendor performance, workmanship quality, responsiveness, and professionalism.</p>
         </section>
         ...
         <section>
           ...
           <p>Megafixx reserves the right to delay, dispute, or deny payment for:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
         ...
         <section>
           ...
           <p>Megafixx may require vendors to complete:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
         ...
         <section>
           ...
           <p>Vendor agrees to keep confidential all non-public information received through Megafixx, including:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
         ...
         <section>
           ...
           <p>Vendor agrees not to directly solicit or independently contract with clients, customers, tenants, or properties introduced through Megafixx-assigned work orders without prior written approval.</p>
         </section>
         ...
         <section>
           ...
           <p>Vendor agrees to hold harmless and indemnify Megafixx Home Services LLC from claims, damages, liabilities, or expenses resulting from vendor negligence, code violations, improper workmanship, or failure to comply with requirements.</p>
         </section>


         <section>
           <h2 className="font-display text-2xl font-bold text-charcoal mb-3">11. Vendor Network Participation</h2>
           <p>Approval within the Megafixx vendor network does not guarantee:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
           ...
           <p>Megafixx reserves the right to assign work orders based on vendor performance, coverage area, availability, client requirements, and operational needs.</p>
         </section>


         <section>
           <h2 className="font-display text-2xl font-bold text-charcoal mb-3">12. Suspension & Termination</h2>
           <p>Megafixx reserves the right to suspend, deactivate, or terminate vendor status at any time, with or without cause.</p>
         ...
         <section>
           ...
           <p>By submitting the vendor onboarding application through the Megafixx website, vendor acknowledges and agrees that:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
             ...
             <li>Vendor agrees to comply with Megafixx operational standards and policies</li>
           ...
           <p>Vendor also consents to receive:</p>
           <ul className="list-disc list-inside space-y-1 ml-2">
             <li>Calls</li>
             <li>Emails</li>
             <li>Text messages</li>
             ...
             <li>Payment communications</li>
           </ul>
           <p>from Megafixx Home Services LLC.</p>
         </section>
       ...
       <div className="mt-8 text-center">
         <Link href="/vendors" className="font-body text-orange hover:text-orange-dark transition-colors duration-300">
