      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="bg-white border border-surface-200 rounded-2xl shadow-card overflow-hidden">
          ...
          <div className="p-8 md:p-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            <div className="flex-1">
              <p className="font-accent text-sm font-semibold text-teal uppercase tracking-widest mb-1">
              ...
              <p className="mt-2 font-body text-text-muted text-base max-w-2xl">
                We appreciate your interest in partnering with HomeProX Services
                LLC. Our team has received your application and will review it
                shortly.
              </p>
            </div>
            <div className="hidden md:flex shrink-0 w-28 h-28 items-center justify-center rounded-2xl bg-surface-50 border border-surface-200">
              <ClipboardCheck className="w-12 h-12 text-teal opacity-80" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-surface-200 rounded-2xl shadow-card p-8 md:p-10">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {[
              ...
              {
                icon: <BriefcaseBusiness className="w-5 h-5 text-teal" />,
                step: "3",
              ...
              >
                ...
                <div className="inline-flex items-center gap-1.5">
                  <span className="w-5 h-5 rounded-full bg-teal text-white text-xs font-bold font-accent flex items-center justify-center">
                    {step}
                  </span>
        ...
        <div className="bg-white border border-surface-200 rounded-2xl shadow-card overflow-hidden">
          <div className="flex items-center gap-3 px-8 py-5 border-b border-surface-200 bg-surface-50">
            <div className="w-8 h-8 rounded-lg bg-teal-muted flex items-center justify-center">
          ...
          <div className="p-8 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-surface-200">
            ...
            <div className="py-8 md:py-0 md:px-8">
              ...
              {remainingServices > 0 && (
                <p className="mt-3 font-body text-xs font-semibold text-teal">
        ...
        <div className="bg-white border border-surface-200 rounded-2xl shadow-card overflow-hidden">
          <div className="flex items-center gap-3 px-8 py-5 border-b border-surface-200 bg-surface-50">
            <CircleAlert className="w-5 h-5 text-teal" />
        ...
        <div className="bg-white border border-surface-200 rounded-2xl shadow-card p-8 md:p-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-surface-200 font-body text-sm text-charcoal hover:border-teal hover:text-teal transition-colors"
            >
              <Phone className="w-4 h-4 text-teal" />
              (817) 518-6296
            </a>
            <a
              href="mailto:vendor@homeproxsvcs.com"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-surface-200 font-body text-sm text-charcoal hover:border-teal hover:text-teal transition-colors"
            >
              <Mail className="w-4 h-4 text-teal" />
              vendor@homeproxsvcs.com
            </a>
            <a
              href="https://homeproxsvcs.com"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-surface-200 font-body text-sm text-charcoal hover:border-teal hover:text-teal transition-colors"
            >
