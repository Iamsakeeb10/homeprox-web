...
const MAX*FILE_BYTES = 10 * 1024 \_ 1024;
...
const label = (data.get(`document_label_${i}`) as string) || `Document ${i + 1}`;
...
<p style="margin: 0 0 16px;">A new vendor application has been submitted through the Megafixx vendor onboarding portal.</p>

       <h2 style="font-size: 18px; margin: 0 0 8px;">Vendor Information</h2>
       <ul style="margin: 0 0 16px 20px; padding: 0;">
         <li><strong>Business Name:</strong> ${companyName}</li>
         <li><strong>DBA / Company Name:</strong> ${companyName}</li>
         <li><strong>Contact Person:</strong> ${contactPerson}</li>
         <li><strong>Phone Number:</strong> ${phone}</li>
         <li><strong>Email Address:</strong> <a href="mailto:${email}">${email}</a></li>
         <li><strong>Business Type:</strong> ${yearsInBusiness ? `In business for ${yearsInBusiness} years` : "—"}</li>
       ...
       <ul style="margin: 0 0 16px 20px; padding: 0;">
         ...
         <li><strong>Weekend Availability:</strong> ${backgroundCheck || "—"}</li>
         <li><strong>After-Hours Availability:</strong> ${backgroundCheck || "—"}</li>
         <li><strong>Emergency Service:</strong> ${sameDayService || "—"}</li>
         <li><strong>Upload Photos & Updates:</strong> Yes</li>
       ...
       <p style="margin: 0 0 16px;">
         The vendor has electronically acknowledged and agreed to the Megafixx Vendor Terms & Conditions and confirmed that all submitted information is accurate and that they operate as an independent contractor with all required licenses and insurance.
       </p>
       ...
       <p style="margin: 0;">
         Megafixx Home Services LLC<br />
         Vendor Onboarding System<br />
         <a href="https://www.megafixxx.com/" target="_blank" rel="noopener noreferrer">https://www.megafixxx.com/</a>
       </p>
     </div>
